...
| 文档 | 版本 | 状态 | 用途 |
|------|------|------|------|
| [逐念而行_Nexum_BP.html](../逐念而行_Nexum_BP.html) | final | ✅ BP | 投资人商业计划书 |
| [Nexum_One_Engineering_Architecture_v0.1.md](Nexum_One_Engineering_Architecture_v0.1.md) | v0.1 | 🟡 Draft | 系统架构、数据流、器件选型、工程风险、原型计划 |
| [Nexum_One_PRD_v1.0.md](Nexum_One_PRD_v1.0.md) | v1.0 | ✅ 可执行 | 产品需求：用户需求→工程需求→功能需求→成功标准 |
| [Nexum_One_Production_BOM_v0.1.md](Nexum_One_Production_BOM_v0.1.md) | v0.1 | 🟡 需验证 | 元器件BOM+供应商+成本估算+降价路线图 |
| [Nexum_One_Firmware_Architecture_v0.1.md](Nexum_One_Firmware_Architecture_v0.1.md) | v0.1 | 🟡 Draft | 固件架构: nRF52832/nRF5340/STM32H743 + BLE协议 |
