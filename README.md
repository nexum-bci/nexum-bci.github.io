...
产品形态：3D打印碳纤维髋部框架（<1.5kg），AKE60电机双侧驱动，IP67防水防尘，热插拔电池续航6小时。配套App通过蓝牙切换三种模式（户外/都市/活力老人）。设备端嵌入式推理<0.5ms。离线工作，无需网络。

**Gen 1不是外骨骼——是可穿戴机器人的第一个形态。** 后续Gen 2增加膝关节模块（2028），Gen 3增加踝关节模块（2030），最终演进为全身可穿戴机器人平台。
...
第一阶段（1-3年）：Kine One。一台可穿戴的物理AI设备。Kickstarter全球首发。它不是外骨骼——它是你身体的一部分。

第二阶段（3-7年）：Kine Pro。全身可穿戴机器人平台。从消费进入康复，从中国走向全球。百万用户。
